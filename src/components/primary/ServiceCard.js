...
function ServiceCard({id,name,description,port}){
    return(
        <div className="card border-2 m-3 text-center justify-content-center" style={{maxWidth:"30vh"}} testid={"ServiceCard:"+id}>
